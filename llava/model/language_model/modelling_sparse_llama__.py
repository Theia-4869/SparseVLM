...
class LlamaDynamicAttention(LlamaAttention):
    def forward(
        self,
...
class LlamaDynamicFlashAttention2(LlamaFlashAttention2):
    def forward(
        self,
...
class LlamaDynamicSdpaAttention(LlamaSdpaAttention):
...
LLAMA_ATTENTION_CLASSES = {
    "eager": LlamaDynamicAttention,
    "flash_attention_2": LlamaDynamicFlashAttention2,
    "sdpa": LlamaDynamicSdpaAttention,
}


class LlamaDynamicDecoderLayer(LlamaDecoderLayer):
...
class LlamaDynamicModel(LlamaModel):
...
class LlamaDynamicForCausalLM(LlamaForCausalLM):
    ...
    def forward(
        ...
        outputs, v_token_num = self.model(
            input_ids=input_ids,
            attention_mask=attention_mask,
            position_ids=position_ids,
